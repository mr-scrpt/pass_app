...
from PySide6.QtWidgets import QDialog, QHBoxLayout, QLabel, QLineEdit, QPushButton, QScrollArea, QVBoxLayout, QWidget
...
class HotkeyCheatsheetDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.scroll.setStyleSheet(
            f"QScrollArea {{ border: 1px solid {extra['primaryColor']}; background-color: transparent; }}"
        )
    ...
    def _build_hotkey_sections(self):
        ...
        sections = [
            ...
            },
            {
                ...
                "items": [("Enter", "Confirm edit"), ("Esc", "Cancel edit"), ("Tab", "Native input navigation")],
            },
            {
            ...
            },
            {
                ...
                "items": [("Enter", "Confirm action"), ("Ctrl+S", "Save (if available)"), ("Esc", "Cancel")],
            },
            {
                "title": "Global Shortcuts",
                "items": [("F1", "Show this help dialog"), ("Ctrl+H", "Show this help dialog (alternative)")],
            },
        ]
    ...
    def _filter_shortcuts(self, text):
        ...
        for i in range(self.content_layout.count()):
            ...
            if widget and hasattr(widget, "hotkey_text"):
                ...
                visible = filter_text in widget.hotkey_text or filter_text in widget.desc_text or not filter_text
